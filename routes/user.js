...
router.get('/', async function (req, res, next) {
  ...
  let values = ["Bridals","Party wear","Traditionals", "Westerns", "Casuals", "Normal wear","Salwars",]
  res.render('./user/index', { admin: false, user, cartCount, pageName: "EvA-Fashion", values });
